                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        ...
                        <select name="trigger" class="form-control" required>
                            <option value="purchase" {{ old('trigger', $template->trigger) == 'purchase' ? 'selected' : '' }}>Purchase</option>
                            <option value="booking" {{ old('trigger', $template->trigger) == 'booking' ? 'selected' : '' }}>Booking</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select name="recipient" class="form-control" required>
                            <option value="customer" {{ old('recipient', $template->recipient) == 'customer' ? 'selected' : '' }}>Customer</option>
                            <option value="admin" {{ old('recipient', $template->recipient) == 'admin' ? 'selected' : '' }}>Admin</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <select name="enabled" class="form-control" required>
                            <option value="1" {{ old('enabled', $template->enabled) == '1' ? 'selected' : '' }}>Enabled</option>
                            <option value="0" {{ old('enabled', $template->enabled) == '0' ? 'selected' : '' }}>Disabled</option>
                        </select>
                    </div>
