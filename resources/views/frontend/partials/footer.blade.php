...
<section id="contact-section" class="py-5 bg-gray">
    <div class="container">
        ...
        <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center">
            <a href="tel:{{ $settings->phone_link ?? '+1234567890' }}" class="btn btn-dark btn-lg px-4 fw-semibold">
            ...
            <a href="https://wa.link/8bgpe5" target="_blank" rel="noopener" class="btn btn-lg px-4 fw-semibold"
                ...
                <i class="bi bi-whatsapp me-2 text-white"></i> Chat on WhatsApp
            </a>
        </div>
    </div>
</section>
