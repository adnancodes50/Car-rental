...
<div id="app">
    ...
    @php
        $heroBg =
            $settings && $settings->hero_image_path
    ...
    <section class="hero d-flex align-items-center text-center text-white position-relative" id="home-section"
        ...
        <div class="container mt-5 position-relative" style="z-index: 2;">
            ...
            <div class="d-flex justify-content-center mb-5">
                <a href="#vehicles" class="btn btn-lg fw-bold px-4 py-3" style="background-color: #CF9B4D">
                                ...
                                <div class="mb-3 d-flex justify-content-between">
                                    ...
                                    @if ($vehicle->purchase_price)
                                        <div class="text-end">
                                            ...
                                            <p class="h5 text-dark mb-0">R{{ number_format($vehicle->purchase_price) }}
                                            </p>
                                        </div>
                                    @endif
                                </div>
