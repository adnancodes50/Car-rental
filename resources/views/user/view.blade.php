            ...
            <div class="row g-4 align-items-stretch">
                @forelse($equipments as $equipment)
                    <div class="col-md-6 col-lg-4">
                        <div
                            class="card vehicle-card shadow-sm border-0 h-100 rounded-4 overflow-hidden d-flex flex-column">
                            ...
                            <div class="card-body d-flex flex-column mt-2">
                                ...
                                {{-- Fixed height stock/location section --}}
                                <div class="row small text-muted mb-3"
                                    style="min-height: 50px; max-height: 50px; overflow-y: auto;">
                                    @forelse($equipment->stocks as $stock)
